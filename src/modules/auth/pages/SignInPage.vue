  ...
  <div class="flex min-h-full flex-col px-6 pt-12 pb-4 lg:px-8">
    <div class="my-auto w-full">
      <header-form
        ...
        :text_title="$t('auth.sign-in.common')"
      />
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <router-link
                  ...
                  >{{ $t('auth.sign-in.forgot_password') }}</router-link
                >
              </div>
            </div>
