<template>
  <div class="flex min-h-full flex-col items-center justify-center px-6 py-12 lg:px-8">
    <div class="text-center">
      <div class="mb-4 inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite] text-indigo-500"></div>
